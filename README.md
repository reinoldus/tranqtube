...
## Development environment and release process
 ...
 - create virtualenv with Flask and tranqtube installed into it (latter is installed in
...
install it (`pip install tranqtube.tar.gz`), ensure that configuration file exists and
`TRANQTUBE_SETTINGS` environment variable points to it, ensure that user has access to the
